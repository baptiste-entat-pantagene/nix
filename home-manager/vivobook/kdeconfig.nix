...
}:
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-339ef2c5-f544-4334-a7c9-ba59f4f7f63d" = "none";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,2,20,15,58,57.295";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."339ef2c5-f544-4334-a7c9-ba59f4f7f63d" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "339ef2c5-f544-4334-a7c9-ba59f4f7f63d";
      "kcminputrc"."Libinput/1267/12766/ASUE1A00:00 04F3:31DE Touchpad"."NaturalScroll" = true;
      ...
      "kdeglobals"."WM"."activeBackground" = "0,0,0";
      ...
      "kdeglobals"."WM"."inactiveForeground" = "165,165,165";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" =
        "/home/baptiste/nix/assets/wallpapers/furry_wallpaper.png";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."SlidePaths" =
        "/nix/store/k9hghs3lq0nxxvrg02805h4pjpqxd996-breeze-6.2.5/share/wallpapers/,/run/current-system/sw/share/wallpapers/";
      "ksplashrc"."KSplash"."Theme" = "a2n.kuro";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "9e4e5b84-b0c1-4818-8fc5-7241145e4b91";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/baptiste/Desktop/ASM/my_cat.S";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,1395,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 733;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1079;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,733,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 1395;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 42;
